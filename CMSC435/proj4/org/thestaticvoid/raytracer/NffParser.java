...
public class NffParser {
	...
	private static void parseFill() throws InvalidNffException {
		String[] tokens = line.split(" ");
		try {
			scene.setFillColor(new Vector3(Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2]), Double.parseDouble(tokens[3])));
		} catch (Exception e) {
	...
	private static void parsePolygon() throws InvalidNffException {
		...
		Polygon polygon = new Polygon(scene.getFillColor());
	...
	private static void parseSphere() throws InvalidNffException {
		String[] tokens = line.split(" ");
		try {
			scene.addSceneObject(new Sphere(scene.getFillColor(), new Vector3(Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2]), Double.parseDouble(tokens[3])), Double.parseDouble(tokens[4])));
		} catch (Exception e) {
